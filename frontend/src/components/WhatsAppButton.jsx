...
import "../styles/whatsappButton.css"; // Styles pour le bouton WhatsApp flottant

export default function WhatsAppButton() {
  // Remplace par ton numéro au format international SANS + ni espaces. Exemple France: 33612345678
  const phoneNumber = "33777381185";

  // Message pré-rempli (optionnel)
  const message = encodeURIComponent("Bonjour, je vous contacte depuis le site Les Colis du Coeur.");

  // Lien WhatsApp (mobile + desktop)
  ...
  return (
    ...
    >
      {/* Icône simple en SVG (pas besoin de lib) */}
      <svg
